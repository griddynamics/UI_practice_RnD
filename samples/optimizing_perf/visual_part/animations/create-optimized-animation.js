...
function main() {
    ...
    for (let i = 0; i < SCENE_OBJECTS; i++) {
        ...
        const objectAnimationRules = generateBouncingAnimation(AnimationStrategy.OPTIMIZED, animationSteps, objectAnimationName);
    ...
    injectAnimatedObjects('index-optimized.html', animationData);
}
